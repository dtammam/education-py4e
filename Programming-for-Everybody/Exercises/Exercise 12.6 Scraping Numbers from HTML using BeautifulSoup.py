...
Scraping Numbers from HTML using BeautifulSoup
 ...
 Actual data: http://py4e-data.dr-chuck.net/comments_1324193.html (Sum ends with 98)
...
url = 'http://py4e-data.dr-chuck.net/comments_1324193.html'
...
# Loop through for <span> tags, count and sum
tags = soup('span')
for tag in tags:
    total = total + int(tag.contents[0])
    count += 1

# Print our total and count!
print(total)
print(count)